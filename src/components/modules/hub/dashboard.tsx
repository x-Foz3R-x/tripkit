  ...
  return (
    <div className="animate-fade-in pb-safe flex flex-col gap-8">
      <header className="flex flex-col gap-2 pt-4 pb-2">
        <h1 className="font-heading text-theme-text mt-1 mb-2 text-[3.5rem] leading-none font-semibold">
          {tripName}
        </h1>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="flex flex-col gap-1.5">
              ...
              <span className="font-body text-theme-text/90 text-[15px] font-medium">
                ul. Stolema 19, 83-322 Stężyca
              </span>
            </div>
            <div className="bg-theme-primary text-theme-primary-foreground flex h-11 w-11 shrink-0 items-center justify-center rounded-full shadow-md">
